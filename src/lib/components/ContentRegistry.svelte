<script lang="ts">
  ...
  import { bugItems, itemById, itemCatalog, javascriptItems } from '$lib/catalogs/items';
  ...
  const chains=[{name:'JavaScript',items:javascriptItems},{name:'Production Bugs',items:bugItems}];
</script>
